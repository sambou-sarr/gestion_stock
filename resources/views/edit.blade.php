                    ...
                    <div class="col-md-10">
                        ...
                        <form action="/update" method="POST" class="w-50">
                            ...
                            <div class="form-group">
                                 ...
                                 <label >Prenom </label>
                            <input class="form-control" type="text" name="prenom" id="prenom" value="{{$items[1]}}"/>

                            </div>

                            <div class="form-group">
                                    <label >Nom </label>
                                    <input class="form-control" type="text" name="nom" id="nom" value="{{$items[2]}}"/>
   
                               </div>
                               <div class="form-group">
                                    <label >Date de naissance </label>
                                    <input class="form-control" type="date" name="datenaiss" id="datenaiss" value="{{$items[3]}}"/>
   
                               </div>
                               <div class="form-group">
                                    <label >Telephone </label>
                                    <input class="form-control" type="text" name="tel" id="tel" value="{{$items[4]}}"/>
